...
def personel_ekran(username):
    ...
    photo_button4=Button(form, image=photo4,borderwidth=0)
    photo_button4.place(x=35,y=540)
    form.photo = photo4  
...
def yönetici_bilgi(username):
    ...
    profil_buton=Button(canvas, text="Çalışan Listesi",font=("Helvetica", 9,"italic"),bg='#D7D7D7', fg="black", width=20, height=2,borderwidth=0,padx=30,command=lambda: [form.destroy(),yönetci_ekran(username)])
    ...
    photo_button2 =Button(form, image=photo2,borderwidth=0)
    photo_button2.place(x=30,y=92)
    form.photo = photo2
    ...
    photo1 = ImageTk.PhotoImage(newphoto1)
    photo_button1 =Button(form, image=photo1,borderwidth=0)
    photo_button1.place(x=30,y=152)
    form.photo = photo1
    
    photo3 = Image.open("C:\\Users\\User\\Desktop\\e.png")
    newphoto3 = photo3.resize((25, 25)) 
    photo3 = ImageTk.PhotoImage(newphoto3)
    photo_button3 =Button(form,image=photo3,borderwidth=0)
    photo_button3.place(x=30,y=212)
    form.photo = photo3
    baglanti,cursor=baglan()
...
def yönetci_ekran(username):
    ...
    profil_buton=Button(canvas, text="Çalışan Listesi",font=("Helvetica", 9,"italic"),bg='#444FEA', fg="black", width=20, height=2,borderwidth=0,padx=30)
    profil_buton.place(y=150)
    ...
    çalışan_button = Button(canvas, text="Profil", font=("Helvetica", 9, "italic"), bg='#D7D7D7', fg="black", width=20, height=2, borderwidth=0,padx=10,command=lambda: [form.destroy(), yönetici_bilgi(username)])
    çalışan_button.place(y=90)
    ...
    newphoto4 = photo4.resize((20, 20)) 
    photo4 = ImageTk.PhotoImage(newphoto4)
    photo_button =Button(form, image=photo4,borderwidth=0)
    ...
    if kullanıcı_bilgileri:
        for i, (ad, eposta) in enumerate(kullanıcı_bilgileri):
            if ad!=username:
                ...
                detay_button = Button(form, text="Detay", font=("Helvetica", 9, "italic"), bg="#444FEA", fg="white", height=1,command=lambda ad=ad: personel_ekran(ad))
...
def login():
    ...
    sign_btn = Button(form, text="Sign Up", font=("Arial", 7), bg='#444FEA', fg='white',command=signup, width=9)
    sign_btn.place(x=470, rely=0.85, anchor="center")
...
def signup():
    global username_entry, password_entry, confirm_entry,x
    remove_widgets()
    ...
    login_btn = Button(form, text="Login", font=("Arial", 7), bg='#444FEA', fg='white',command=login, width=9)
    login_btn.place(x=470, rely=0.86, anchor="center")
